...
${UNITY_EXECUTABLE:-xvfb-run --auto-servernum --server-args='-screen 0 640x480x24' unity-editor} \
  ...
  -coverageOptions "generateAdditionalMetrics;generateHtmlReport;generateHtmlReportHistory;generateBadgeReport;pathFilters:-*/Assets/MapGenerator/MapGenerator.Shared/SimpleJSON.cs,-*/Assets/MapGenerator/Scripts/CommandLineInterface/Mono.Options/*;" \
